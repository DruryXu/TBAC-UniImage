...
class TBACUniImageConfig(MLLMInContextConfig):
...
class TBACUniImage(PreTrainedModel):
    config_class = TBACUniImageConfig
    ...
    def sample_images(
        ...
        **kwargs,
        ...
        if isinstance(input_images, list) and all([img is None for img in input_images]):
            input_images = None
